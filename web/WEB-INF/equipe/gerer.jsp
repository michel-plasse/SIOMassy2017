<div class="col-md-12">
    ...
    <form name="manage" method="POST" action="<c:url value="/etudiant/equipe/gerer"><c:param name="id" value="${equipeGeree.id}" /></c:url>">
        ...
        <div class="col-md-4">
            <fieldset>
                ...
                <br />
                <a class="btn btn-default" href="<c:url value="/etudiant/equipe/index" ><c:param name="id" value="${requestScope.equipeGeree.idProjet}" /></c:url>">
